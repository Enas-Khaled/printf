...
/**
 * print_normal_number - writes a number with options
...
int print_normal_number(char *str, params_t *params)
{
	...
	if (!params->minus_flag)
		return (print_number_right_to_shift(str, params));
	else
		return (print_number_left_to_shift(str, params));
}

/**
 * print_number_right_to_shift - prints a number with options
 * @str: base number as a string
 * @params: parameter struct
 *
 * Return: printedchars
...
int print_number_right_to_shift(char *str, params_t *params)
{
	...
	if (neg && i < params->width && my_pad_char == '0' && !params->minus_flag)
		str++;
	else
		neg = 0;
...
/**
 * print_number_left_to_shift - prints a number with options
 * @str: base number as a string
 * @params: parameter struct
 *
